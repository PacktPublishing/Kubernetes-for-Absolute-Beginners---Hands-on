...
### Important Note:
Kindy refer to the updated Lab links and refer to the instructions given in "[Accessing the Labs - Kubernetes.pdf](https://github.com/PacktPublishing/-Kubernetes-for-Absolute-Beginners---Hands-on/blob/master/Accessing%20the%20Labs%20-%20Kubernetes.pdf)" to get started with the labs.  
